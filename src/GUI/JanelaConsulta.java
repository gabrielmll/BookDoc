...
public class JanelaConsulta extends JFrame {
	...
	private void initialize() {
		...
		frameJanelaConsulta.addWindowListener(new CloseWindows());
	...
	private void telaConsulta() {
		...
		String[] tipoEspecialidade = { "Pediatra", "Urologista",
				"Cardiologista" };
		JComboBox comboTipoEspecialidade = new JComboBox(tipoEspecialidade);
		comboTipoEspecialidade
		...
		String[] medico = { "Roberto Marinho", "Fernando Henrique",
				"Alexandre Kalil" };
